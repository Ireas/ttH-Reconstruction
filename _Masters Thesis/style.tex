...
\newcommand{\ttX}           {\mbox{$t\bar{t}+X$}\xspace}
\newcommand{\ttHWW}         {\mbox{$t\bar{t}(H\rightarrow WW^*)$}\xspace}
\newcommand{\ttHbb}         {\mbox{$t\bar{t}(H\rightarrow bb)$}\xspace}
\newcommand{\ttHcc}         {\mbox{$t\bar{t}(H\rightarrow cc)$}\xspace}
\newcommand{\ttHtautau}     {\mbox{$t\bar{t}(H\rightarrow \tau\tau)$}\xspace}
\newcommand{\ttHWWqqqq}     {\mbox{$t\bar{t}(H\rightarrow WW^*\rightarrow qqqq)$}\xspace}
\newcommand{\ttHWWlvqq}     {\mbox{$t\bar{t}(H\rightarrow WW^*\rightarrow l\nu qq)$}\xspace}
\newcommand{\ttHWWlvlv}     {\mbox{$t\bar{t}(H\rightarrow WW^*\rightarrow l\nu l\nu)$}\xspace}
\newcommand{\ttHother}      {\mbox{$t\bar{t}(H\rightarrow \text{other})$}\xspace}
\newcommand{\HWW}           {\mbox{$H\rightarrow WW^*$}\xspace}
\newcommand{\Hbb}           {\mbox{$H\rightarrow bb$}\xspace}
\newcommand{\spanet}        {\textit{SPA-Net}\xspace}
\newcommand{\spanets}       {\textit{SPA-Net}'s\xspace}
\newcommand{\NW}            {\textit{Neutrino Weighting}\xspace}
