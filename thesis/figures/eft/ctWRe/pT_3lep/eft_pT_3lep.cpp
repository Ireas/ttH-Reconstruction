...
int eft_pT_3lep(){
	...
	std::string pathOutput = "/home/ireas/Desktop/eft_analysis/ctWRe/pT_3lep/";
	...
	TH1F* hist_ttZ_default = new TH1F("Region00d", "ttZ_default", 4,15,80);
	TH1F* hist_ttZ_c1 = new TH1F("Region00c1", "ttZ_c1", 4,15,80);
	TH1F* hist_ttZ_c2 = new TH1F("Region00c2", "ttZ_c2", 4,15,80);
	TH1F* hist_ttZ_c3 = new TH1F("Region00c3", "ttZ_c3", 4,15,80);
	TH1F* hist_ttZ_c4 = new TH1F("Region00c4", "ttZ_c4", 4,15,80);
	...
	TH1F* hist_ttW_default = new TH1F("Region01d", "ttW_default", 4,15,80);
	TH1F* hist_ttW_c1 = new TH1F("Region01c1", "ttW_c1", 4,15,80);
	TH1F* hist_ttW_c2 = new TH1F("Region01c2", "ttW_c2", 4,15,80);
	TH1F* hist_ttW_c3 = new TH1F("Region01c3", "ttW_c3", 4,15,80);
	TH1F* hist_ttW_c4 = new TH1F("Region01c4", "ttW_c4", 4,15,80);
	...
	TH1F* hist_Fakes_default = new TH1F("Region02d", "Fakes_default", 4,15,80);
	TH1F* hist_Fakes_c1 = new TH1F("Region02c1", "Fakes_c1", 4,15,80);
	TH1F* hist_Fakes_c2 = new TH1F("Region02c2", "Fakes_c2", 4,15,80);
	TH1F* hist_Fakes_c3 = new TH1F("Region02c3", "Fakes_c3", 4,15,80);
	TH1F* hist_Fakes_c4 = new TH1F("Region02c4", "Fakes_c4", 4,15,80);
	...
	c_smeft.SetBranchAddress("mz1_dR", &mz1_dR);
	...
	for(int i=0; i<c_smeft.GetEntries(); i++){
		...
		if( (MyModel_ttW<0.4) && (MyModel_Fakes<0.4) ){		
			(hist_array_ttZ[0])->Fill(pT_3lep, weight_default);
			(hist_array_ttZ[1])->Fill(pT_3lep, weight_c1);
			(hist_array_ttZ[2])->Fill(pT_3lep, weight_c2);
			(hist_array_ttZ[3])->Fill(pT_3lep, weight_c3);
			(hist_array_ttZ[4])->Fill(pT_3lep, weight_c4);
		}
		if( (MyModel_ttW>=0.4) ){
			(hist_array_ttW[0])->Fill(pT_3lep, weight_default);
			(hist_array_ttW[1])->Fill(pT_3lep, weight_c1);
			(hist_array_ttW[2])->Fill(pT_3lep, weight_c2);
			(hist_array_ttW[3])->Fill(pT_3lep, weight_c3);
			(hist_array_ttW[4])->Fill(pT_3lep, weight_c4);
		}
		if( (MyModel_ttW<0.4) && (MyModel_Fakes>=0.4) ){		
			(hist_array_Fakes[0])->Fill(pT_3lep, weight_default);
			(hist_array_Fakes[1])->Fill(pT_3lep, weight_c1);
			(hist_array_Fakes[2])->Fill(pT_3lep, weight_c2);
			(hist_array_Fakes[3])->Fill(pT_3lep, weight_c3);
			(hist_array_Fakes[4])->Fill(pT_3lep, weight_c4);
		}
