...
legend.AddEntry(ttZ_c1,         "ctWRe +0.7", "L")
legend.AddEntry(ttZ_c2,         "ctWRe -0.7", "L")
legend.AddEntry(ttZ_c3,         "ctWRe +1.1", "L")
legend.AddEntry(ttZ_c4,         "ctWRe -1.1", "L")
aplt.atlas_label(text="Internal", loc="upper left")
ax1A.text(0.2, 0.84, "#sqrt{s}=13 TeV, 139 fb^{-1}", size=22, align=13)
ax1A.text(0.2, 0.78, "SR-offZ-ttZ", size=22, align=13)
ax1A.text(0.2, 0.72, "O_{tW} for different real Wilson coefficients", size=22, align=13)
...
legend.AddEntry(ttW_c1,         "ctWRe +0.7", "L")
legend.AddEntry(ttW_c2,         "ctWRe -0.7", "L")
legend.AddEntry(ttW_c3,         "ctWRe +1.1", "L")
legend.AddEntry(ttW_c4,         "ctWRe -1.1", "L")
aplt.atlas_label(text="Internal", loc="upper left")
ax1B.text(0.2, 0.84, "#sqrt{s}=13 TeV, 139 fb^{-1}", size=22, align=13)
ax1B.text(0.2, 0.78, "CR-offZ-ttW", size=22, align=13)
ax1B.text(0.2, 0.72, "O_{tW} for different real Wilson coefficients", size=22, align=13)
...
legend.AddEntry(Fakes_c1,         "ctWRe +0.7", "L")
legend.AddEntry(Fakes_c2,         "ctWRe -0.7", "L")
legend.AddEntry(Fakes_c3,         "ctWRe +1.1", "L")
legend.AddEntry(Fakes_c4,         "ctWRe -1.1", "L")
aplt.atlas_label(text="Internal", loc="upper left")
ax1C.text(0.2, 0.84, "#sqrt{s}=13 TeV, 139 fb^{-1}", size=22, align=13)
ax1C.text(0.2, 0.78, "CR-offZ-Fakes", size=22, align=13)
ax1C.text(0.2, 0.72, "O_{tW} for different real Wilson coefficients", size=22, align=13)
