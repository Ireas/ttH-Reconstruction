...
int eft_cost_theta_starZ(){
	...
	std::string pathOutput = "/home/ireas/Desktop/eft_analysis/ctWRe/cos_theta_starZ/";

	int index_default = 0;
	int index_c1 = 698; //p0.7
	int index_c2 = 587; //m0.7
	int index_c3 = 809; //p1.0
	int index_c4 = 476; //m1.1
