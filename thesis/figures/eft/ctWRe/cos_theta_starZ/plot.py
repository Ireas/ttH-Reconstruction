...
ax1A.text(0.2, 0.76, "Variations on real part of C_{tW}", size=22, align=13)
...
ax1B.text(0.2, 0.76, "Variations on real part of C_{tW}", size=22, align=13)
...
ax1C.text(0.2, 0.76, "Variations on real part of C_{tW}", size=22, align=13)
