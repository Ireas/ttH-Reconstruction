...
int eft_mz1_dR(){
	...
	std::string pathOutput = "/home/ireas/Desktop/eft_analysis/ctWRe/mz1_dR/";
	...
	for(int i=0; i<c_smeft.GetEntries(); i++){
		...
		if( (MyModel_ttW<0.4) && (MyModel_Fakes<0.4) ){		
			(hist_array_ttZ[0])->Fill(mz1_dR, weight_default);
			(hist_array_ttZ[1])->Fill(mz1_dR, weight_c1);
			(hist_array_ttZ[2])->Fill(mz1_dR, weight_c2);
			(hist_array_ttZ[3])->Fill(mz1_dR, weight_c3);
			(hist_array_ttZ[4])->Fill(mz1_dR, weight_c4);
		}
		if( (MyModel_ttW>=0.4) ){
			(hist_array_ttW[0])->Fill(mz1_dR, weight_default);
			(hist_array_ttW[1])->Fill(mz1_dR, weight_c1);
			(hist_array_ttW[2])->Fill(mz1_dR, weight_c2);
			(hist_array_ttW[3])->Fill(mz1_dR, weight_c3);
			(hist_array_ttW[4])->Fill(mz1_dR, weight_c4);
		}
		if( (MyModel_ttW<0.4) && (MyModel_Fakes>=0.4) ){		
			(hist_array_Fakes[0])->Fill(mz1_dR, weight_default);
			(hist_array_Fakes[1])->Fill(mz1_dR, weight_c1);
			(hist_array_Fakes[2])->Fill(mz1_dR, weight_c2);
			(hist_array_Fakes[3])->Fill(mz1_dR, weight_c3);
			(hist_array_Fakes[4])->Fill(mz1_dR, weight_c4);
		}
