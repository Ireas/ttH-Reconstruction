...
int eft_cost_theta_starZ(){
	...
	std::string pathOutput = "/home/ireas/Desktop/eft_analysis/ctWIm/cos_theta_starZ/";

	int index_default = 0;
	int index_c1 = 943; //p0.6
	int index_c2 = 932; //m0.8
	int index_c3 = 954; //p1.2	
	int index_c4 = 921; //m1.4
	...
	TH1F* hist_ttZ_default = new TH1F("Region00d", "ttZ_default", 6,-1,1);
	TH1F* hist_ttZ_c1 = new TH1F("Region00c1", "ttZ_c1", 6,-1,1);
	TH1F* hist_ttZ_c2 = new TH1F("Region00c2", "ttZ_c2", 6,-1,1);
	TH1F* hist_ttZ_c3 = new TH1F("Region00c3", "ttZ_c3", 6,-1,1);
	TH1F* hist_ttZ_c4 = new TH1F("Region00c4", "ttZ_c4", 6,-1,1);
	...
	TH1F* hist_ttW_default = new TH1F("Region01d", "ttW_default", 6,-1,1);
	TH1F* hist_ttW_c1 = new TH1F("Region01c1", "ttW_c1", 6,-1,1);
	TH1F* hist_ttW_c2 = new TH1F("Region01c2", "ttW_c2", 6,-1,1);
	TH1F* hist_ttW_c3 = new TH1F("Region01c3", "ttW_c3", 6,-1,1);
	TH1F* hist_ttW_c4 = new TH1F("Region01c4", "ttW_c4", 6,-1,1);
	...
	TH1F* hist_Fakes_default = new TH1F("Region02d", "Fakes_default", 6,-1,1);
	TH1F* hist_Fakes_c1 = new TH1F("Region02c1", "Fakes_c1", 6,-1,1);
	TH1F* hist_Fakes_c2 = new TH1F("Region02c2", "Fakes_c2", 6,-1,1);
	TH1F* hist_Fakes_c3 = new TH1F("Region02c3", "Fakes_c3", 6,-1,1);
	TH1F* hist_Fakes_c4 = new TH1F("Region02c4", "Fakes_c4", 6,-1,1);
	...
	c_smeft.SetBranchAddress("cos_theta_starZ", &cos_theta_starZ);
	...
	for(int i=0; i<c_smeft.GetEntries(); i++){
		...
		if( (MyModel_ttW<0.4) && (MyModel_Fakes<0.4) ){		
			(hist_array_ttZ[0])->Fill(cos_theta_starZ, weight_default);
			(hist_array_ttZ[1])->Fill(cos_theta_starZ, weight_c1);
			(hist_array_ttZ[2])->Fill(cos_theta_starZ, weight_c2);
			(hist_array_ttZ[3])->Fill(cos_theta_starZ, weight_c3);
			(hist_array_ttZ[4])->Fill(cos_theta_starZ, weight_c4);
		}
		if( (MyModel_ttW>=0.4) ){
			(hist_array_ttW[0])->Fill(cos_theta_starZ, weight_default);
			(hist_array_ttW[1])->Fill(cos_theta_starZ, weight_c1);
			(hist_array_ttW[2])->Fill(cos_theta_starZ, weight_c2);
			(hist_array_ttW[3])->Fill(cos_theta_starZ, weight_c3);
			(hist_array_ttW[4])->Fill(cos_theta_starZ, weight_c4);
		}
		if( (MyModel_ttW<0.4) && (MyModel_Fakes>=0.4) ){		
			(hist_array_Fakes[0])->Fill(cos_theta_starZ, weight_default);
			(hist_array_Fakes[1])->Fill(cos_theta_starZ, weight_c1);
			(hist_array_Fakes[2])->Fill(cos_theta_starZ, weight_c2);
			(hist_array_Fakes[3])->Fill(cos_theta_starZ, weight_c3);
			(hist_array_Fakes[4])->Fill(cos_theta_starZ, weight_c4);
		}
