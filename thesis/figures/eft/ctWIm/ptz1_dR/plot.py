...
ax1A.text(0.2, 0.72, "O_{tW} for different imaginary  Wilson coefficients", size=22, align=13)
...
ax1B.text(0.2, 0.72, "O_{tW} for different imaginary Wilson coefficients", size=22, align=13)
...
ax1C.text(0.2, 0.72, "O_{tW} for different imaginary Wilson coefficients", size=22, align=13)
