...
legend.AddEntry(ttZ_default,    "SM prediction", "L")
...
ax1A.text(0.2, 0.76, "Variations on imaginary part of C_{tB}", size=22, align=13)

### Labels Plot B
ax1B.cd()
legend = ax1B.legend(loc=(0.7, 0.6, 1-root.gPad.GetRightMargin(), 1-root.gPad.GetTopMargin()-0.05), textsize=22, labelspacing=250 )
legend.AddEntry(ttW_default,    "SM prediction", "L")
...
ax1B.text(0.2, 0.76, "Variations on imaginary part of C_{tB}", size=22, align=13)

### Labels Plot C
ax1C.cd()
legend = ax1C.legend(loc=(0.7, 0.6, 1-root.gPad.GetRightMargin(), 1-root.gPad.GetTopMargin()-0.05), textsize=22, labelspacing=250 )
legend.AddEntry(Fakes_default,    "SM prediction", "L")
...
ax1C.text(0.2, 0.76, "Variations on imaginary part of C_{tB}", size=22, align=13)
