...
int eft_cost_theta_starZ(){
	...
	std::string pathOutput = "/home/ireas/Desktop/eft_analysis/ctBIm/cos_theta_starZ/";

	int index_default = 0;
	int index_c1 = 988;  //p0.6
	int index_c2 = 976;  //m0.6
	int index_c3 = 998;  //p1.8
	int index_c4 = 965;  //m1.8
