...
string_xlabel = "Trans. Momentum p_{T} of Z-Boson using \\Delta R [GeV]"
string_file = "ptz1_dR"
...
legend.AddEntry(ttZ_c1,         "ctBIm +0.6", "L")
legend.AddEntry(ttZ_c2,         "ctBIm -0.6", "L")
legend.AddEntry(ttZ_c3,         "ctBIm +1.8", "L")
legend.AddEntry(ttZ_c4,         "ctBIm -1.8", "L")
aplt.atlas_label(text="Internal", loc="upper left")
ax1A.text(0.2, 0.84, "#sqrt{s}=13 TeV, 139 fb^{-1}", size=22, align=13)
ax1A.text(0.2, 0.78, "SR-offZ-ttZ", size=22, align=13)
ax1A.text(0.2, 0.72, "O_{tB} for different imaginary  Wilson coefficients", size=22, align=13)
...
legend.AddEntry(ttW_c1,         "ctBIm +0.6", "L")
legend.AddEntry(ttW_c2,         "ctBIm -0.6", "L")
legend.AddEntry(ttW_c3,         "ctBIm +1.8", "L")
legend.AddEntry(ttW_c4,         "ctBIm -1.8", "L")
aplt.atlas_label(text="Internal", loc="upper left")
ax1B.text(0.2, 0.84, "#sqrt{s}=13 TeV, 139 fb^{-1}", size=22, align=13)
ax1B.text(0.2, 0.78, "CR-offZ-ttW", size=22, align=13)
ax1B.text(0.2, 0.72, "O_{tB} for different imaginary Wilson coefficients", size=22, align=13)
...
legend.AddEntry(Fakes_c1,         "ctBIm +0.6", "L")
legend.AddEntry(Fakes_c2,         "ctBIm -0.6", "L")
legend.AddEntry(Fakes_c3,         "ctBIm +1.8", "L")
legend.AddEntry(Fakes_c4,         "ctBIm -1.8", "L")
aplt.atlas_label(text="Internal", loc="upper left")
ax1C.text(0.2, 0.84, "#sqrt{s}=13 TeV, 139 fb^{-1}", size=22, align=13)
ax1C.text(0.2, 0.78, "CR-offZ-Fakes", size=22, align=13)
ax1C.text(0.2, 0.72, "O_{tB} for different imaginary Wilson coefficients", size=22, align=13)
