...
TFileArray = [TFile("cos_theta_starZ/output_nominalised.root"), TFile("mz1/output_nominalised.root"), TFile("mz1_dR/output_nominalised.root"), TFile("ptz1/output_nominalised.root"), TFile("ptz1_dR/output_nominalised.root")]
