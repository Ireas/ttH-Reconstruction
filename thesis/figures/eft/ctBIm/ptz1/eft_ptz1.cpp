...
int eft_ptz1(){
	...
	std::string pathOutput = "/home/ireas/Desktop/eft_analysis/ctBIm/ptz1/";
	...
	c_smeft.SetBranchAddress("ptz1", &ptz1);
	...
	for(int i=0; i<c_smeft.GetEntries(); i++){
		...
		if( (MyModel_ttW<0.4) && (MyModel_Fakes<0.4) ){		
			(hist_array_ttZ[0])->Fill(ptz1, weight_default);
			(hist_array_ttZ[1])->Fill(ptz1, weight_c1);
			(hist_array_ttZ[2])->Fill(ptz1, weight_c2);
			(hist_array_ttZ[3])->Fill(ptz1, weight_c3);
			(hist_array_ttZ[4])->Fill(ptz1, weight_c4);
		}
		if( (MyModel_ttW>=0.4) ){
			(hist_array_ttW[0])->Fill(ptz1, weight_default);
			(hist_array_ttW[1])->Fill(ptz1, weight_c1);
			(hist_array_ttW[2])->Fill(ptz1, weight_c2);
			(hist_array_ttW[3])->Fill(ptz1, weight_c3);
			(hist_array_ttW[4])->Fill(ptz1, weight_c4);
		}
		if( (MyModel_ttW<0.4) && (MyModel_Fakes>=0.4) ){		
			(hist_array_Fakes[0])->Fill(ptz1, weight_default);
			(hist_array_Fakes[1])->Fill(ptz1, weight_c1);
			(hist_array_Fakes[2])->Fill(ptz1, weight_c2);
			(hist_array_Fakes[3])->Fill(ptz1, weight_c3);
			(hist_array_Fakes[4])->Fill(ptz1, weight_c4);
		}
